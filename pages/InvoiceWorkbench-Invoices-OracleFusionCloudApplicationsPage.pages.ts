...
import locators from '../locators/InvoiceWorkbench-Invoices-OracleFusionCloudApplicationsPage';

class InvoiceWorkbenchInvoicesOracleFusionCloudApplicationsPage {
  page: Page;
  helper: HelperClass;
  ...
  constructor(page: Page) {
    ...
    this.createInvoiceButton = page.locator(locators.createInvoiceButton).first();
...
export default InvoiceWorkbenchInvoicesOracleFusionCloudApplicationsPage;
